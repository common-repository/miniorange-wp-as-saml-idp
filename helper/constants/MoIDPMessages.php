<?php
/**
 * This file contains the `MoIDPMessages` class that defines
 * various messages used through out the plugin.
 *
...
/**
 * This class defines various messages used through
 * out the plugin.
 */
class MoIDPMessages {
	...
	const ERROR_OCCURRED  = 'An error occurred while processing your request. Please try again.';
	...
	const LICENSE_KEY_IN_USE  = 'License key you have entered has already been used. Please enter a key which has not been used before on any other instance or if you have exhausted all your keys then contact us at info@miniorange.com to buy more keys.';
	...
	const INVALID_REQUEST_INSTANT   = 'INVALID_REQUEST: Request time is greater than the current time.';
	const INVALID_SAML_VERSION      = 'We only support SAML 2.0! Please send a SAML 2.0 request.';
	const INVALID_SP                = 'INVALID_SP: No Service Provider configuration found. Please configure your Service Provider.';
	const INVALID_REQUEST_SIGNATURE = 'INVALID_SIGNATURE: Invalid Signature!';
	const SAML_INVALID_OPERATION    = 'INVALID_OPERATION: Invalid Operation! Please contact your site administrator.';
	...
	// WP File System Error Messages.
	const READ_ONLY_PERMISSIONS = 'INVALID_PERMISSIONS: File permissions read-only. You can reach out to <a href="mailto:wpidpsupport@xecurify.com">wpidpsupport@xecurify.com</a> for help.';

	/**
	 * Prepares the message to be displayed by
	 * substituting values if required, and
	 * returns the message to be displayed.
	 *
	 * @param string $message Refers to the constant name.
	 * @param array  $data Refers to additional parameters that need to be displayed.
	 * @return string
	 */
