 ...
 * the contact support widget form.
 *
...
echo '
	...
	<div class="mo-idp-contact-form" id="idp-contact-button-form" hidden>
		...
		<form name="f" method="post" action="">
			...
			wp_nonce_field( $support_nonce );
echo '		<table style="width:100%;margin-bottom:2%;">
				<tr>
					<td>';
		...
		echo '<p style="font-size: 0.875rem;"><b>Reach out to us at <span><a href="mailto:' . esc_attr( $support ) . '">' . esc_attr( $support ) . '</a></span></b></p>';
	echo ' </div>';
