...
echo '<div id="mo-idp-successDiv" style="display:none; width:91.4%; margin:auto; margin-top:0.625rem; color:black; background-color:rgba(44, 252, 2, 0.15); 
            padding:0.938rem; border:solid 1px rgba(55, 242, 07, 0.36); font-size:large; line-height:normal;transform:translate(10px);">
        ...
        <div class="mo-idp-table-layout mo-idp-center mo-idp-sp-width ">
						...
						echo ' <a class="mo-idp-btn-cstm" href="' . esc_url( $metadata_url ) . '" download="mo-idp-metadata.xml">Download <img style="width: 1.5rem;
                            filter: invert(1);
                            position: relative;
                            top: 0.3rem;" src="' . esc_url( MSI_URL ) . 'includes/images/download-icon.png"/></a>';
					echo ' </div>        
					...
					echo ' <tr>
                                ...
                                <div class="mo-idp-table-btn-cstm mo-idp-metadata-prem-feature-btn">
                                    <a  href="' . esc_url( $license_url ) . '" target="_blank" class="mo-idp-upload-data-anchor" style="color:orange;"><img src="' . esc_url( MSI_URL ) . 'includes/images/star.png" style="width:1rem;">
                                    Premium Feature   
                                </div>
                                </td>
                            </tr>';
...
if ( ! $expired_cert ) {
	echo '<td style="width:60%;  padding: 1.6rem 1.6rem;">
                                    <div class="mo-idp-note" style="border-width:0.625rem; border-color: red;width:auto;">
                                        <form name="f" method="post" action="" id="mo_idp_new_cert_form">
                                            <input type="hidden" name="option" value="mo_idp_use_new_cert" />
                                        </form>
							...
							echo '  <a  href="' . esc_url( $license_url ) . '" target="_blank" style="color:orange;" class="mo-idp-upload-data-anchor"><img src="' . esc_url( MSI_URL ) . 'includes/images/star.png" style="width:1rem;">';
...
echo '                      <div class="mo-idp-flex mo-idp-mt-5">
                                <input  type="submit" 
                                    name="submit" 
                                    style="width:6.25rem;" 
                                    value="Update" 
