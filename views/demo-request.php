            ...
            <div class="mo-idp-demo-table mo-idp-flex" style="justify-content:space-around;align-items:start">
               <div class="mo-idp-demo-table1"> 
                ...
                <div class="mo-idp-demo-table2">
                    ...
                    <br>';
					echo '<span style="font-size:1rem;font-weight: 600;margin-left: 2rem;">For more details, <a href="' . esc_url( $license_url ) . '" target="_blank">click here &#8594</a></span>';
			echo ' </div>
                <!--end of table2-->
            </div> <!--end of flex div-->
                </div>
