<?php
/**
 * This file contains the `PasswordResetFailedException` class that defines
 * an exception when the password reset operation failed.
 *
...
/**
 * Exception denotes that the password reset operation failed.
 */
class PasswordResetFailedException extends \Exception {
	...
	public function __construct() {
		$message = MoIDPMessages::show_message( 'ERROR_OCCURRED' );
		$code    = 116;
