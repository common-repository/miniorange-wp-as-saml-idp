<?php
/**
 * This file contains the `MetadataFileException` class that defines
 * an exception when the uploaded metadata file is empty / invalid.
 *
...
/**
 * Exception denotes that the uploaded metadata file
 * is empty / invalid.
 */
class MetadataFileException extends \Exception {
	...
	public function __construct() {
		$message = MoIDPMessages::show_message( 'METADATA_FILE_URL_NOT_UPLOADED' );
		$code    = 129;
