<?php
/**
 * This file contains the `InvalidEncryptionCertException` class that defines
 * an exception when the user did not provide a valid certificate while configuring
...
/**
 * Exception denotes that user did not provide a valid
...
class InvalidEncryptionCertException extends \Exception {
	...
	public function __construct() {
		$message = MoIDPMessages::show_message( 'INVALID_ENCRYPT_CERT' );
		$code    = 108;
