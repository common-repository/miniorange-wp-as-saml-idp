<?php
/**
 * This file contains the `OTPSendingFailedException` class that defines
 * an exception when an error occurred while sending OTP to the admin / user.
 *
...
class OTPSendingFailedException extends \Exception {
	...
	public function __construct() {
		$message = MoIDPMessages::show_message( 'ERROR_SENDING_OTP' );
		$code    = 115;
