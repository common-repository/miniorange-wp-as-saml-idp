<?php
/**
 * This file contains the `RequiredFieldsException` class that defines
 * an exception when one or more required fields are empty at the time
 * of form submission.
 *
...
/**
 * Exception denotes that one or more required fields are empty
...
class RequiredFieldsException extends \Exception {
	...
	public function __construct() {
		$message = MoIDPMessages::show_message( 'REQUIRED_FIELDS' );
		$code    = 104;
