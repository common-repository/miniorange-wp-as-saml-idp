<?php
/**
 * This file contains the `NoServiceProviderConfiguredException` class that defines
 * an exception when the admin has not configured a Service Provider.
 *
...
/**
 * Exception denotes that the admin has not configured a Service Provider.
 */
class NoServiceProviderConfiguredException extends \Exception {
	...
	public function __construct() {
		$message = MoIDPMessages::show_message( 'NO_SP_CONFIG' );
		$code    = 101;
